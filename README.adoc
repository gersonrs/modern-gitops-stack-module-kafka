...
==== [[input_kafka_name]] <<input_kafka_name,kafka_name>>
...
==== [[input_kafka_users]] <<input_kafka_users,kafka_users>>
...
==== [[output_broker_name]] <<output_broker_name,broker_name>>
...
|[[input_kafka_users]] <<input_kafka_users,kafka_users>>
|Kafka SCRAM users to be created by Strimzi for internal clients.
|`list(string)`
|
...
|[[output_broker_name]] <<output_broker_name,broker_name>> |kafka broker name
|===
// END_TF_TABLES
====
